...
def initialise_fields(mesh, inputdir, outputdir, identifier, manning=False):
    """
    function that takes fields from preprocessing or ramp stages
    :param mesh: Mesh
    :param inputdir: input file directory
    :param outputdir: output file directory
    :param identifier: identifier (for runs)
    :param manning: flag on whether manning field will be imported
    :return:
    """

    CG_2d = FunctionSpace(mesh, 'CG', 1)
