...
A 2D hydrodynamic model for simulating multiple idealised tidal range power plant (TPP) lagoons in the Severn Estuary and wider West UK coastal region, built on the [Thetis](https://thetisproject.org/) finite element ocean model.
